...
const (
	TokenRing_RequestToken_FullMethodName = "/TokenRing/RequestToken"
...
type TokenRingClient interface {
	RequestToken(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*TokenReply, error)
	PassToken(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*TokenReply, error)
}
...
func (c *tokenRingClient) RequestToken(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*TokenReply, error) {
...
func (c *tokenRingClient) PassToken(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*TokenReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TokenReply)
...
type TokenRingServer interface {
	RequestToken(context.Context, *TokenRequest) (*TokenReply, error)
	PassToken(context.Context, *TokenRequest) (*TokenReply, error)
...
func (UnimplementedTokenRingServer) RequestToken(context.Context, *TokenRequest) (*TokenReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RequestToken not implemented")
}
func (UnimplementedTokenRingServer) PassToken(context.Context, *TokenRequest) (*TokenReply, error) {
...
func _TokenRing_RequestToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TokenRingServer).RequestToken(ctx, req.(*TokenRequest))
	}
...
func _TokenRing_PassToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TokenRingServer).PassToken(ctx, req.(*TokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
